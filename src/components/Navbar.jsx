...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        <div className={cn(
          'flex items-center justify-between h-14 px-3 rounded-2xl transition-all duration-300 navbar-fixed',
          '!border !border-[rgba(255,255,255,0.1)] hover:!border-[#12AAFF]/40',
