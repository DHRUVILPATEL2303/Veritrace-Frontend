...
export default function HomePage() {
  ...
  return (
    <>
      {/* ════ HERO ════ */}
      <div className="home-hero pt-14 pb-24 relative overflow-hidden">
        {/* BackgroundRippleEffect — interactive grid behind hero content */}
        <div className="absolute inset-0 z-0">
          <BackgroundRippleEffect rows={7} cols={26} cellSize={56} />
        </div>
