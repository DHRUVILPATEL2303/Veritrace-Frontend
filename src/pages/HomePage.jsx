        ...
        <section className="max-w-[1280px] mx-auto px-5 pb-16">
          <div className="relative overflow-hidden rounded-3xl border-2 border-[var(--accent)]/30 bg-gradient-to-br from-[var(--accent)]/10 via-[var(--accent-dark)]/5 to-[var(--success-bg)] p-10 text-center">
            ...
            <div className="relative z-10">
              ...
              >
                <h2 className="text-2xl sm:text-3xl font-extrabold mb-3 text-[var(--text)]">Ready to anchor your first proof?</h2>
                <p className="text-sm text-[var(--text-3)] max-w-lg mx-auto mb-6">Join the open registry. Every proof you create is permanently verifiable and tamper-evident.</p>
