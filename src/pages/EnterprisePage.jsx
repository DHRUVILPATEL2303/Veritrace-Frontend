        ...
        <div className="max-w-[1280px] mx-auto px-5 pt-7 pb-20">
          ...
          <div className="flex border-b border-[var(--border)] mb-6 gap-2">
            <button
              ...
              className={`py-3 px-6 text-sm font-semibold border-b-2 transition-all ${activeTab === 'dataset'
            ...
            <button
              ...
              className={`py-3 px-6 text-sm font-semibold border-b-2 transition-all ${activeTab === 'publisher'
                  ? 'border-[var(--accent)] text-[var(--accent)] bg-[var(--accent)]/5 rounded-t-xl'
                  : 'border-transparent text-[var(--text-3)] hover:text-[var(--text-2)]'
                }`}
            >
              ...
              <div className="flex flex-col gap-5">
                <SpotlightCard>
                  <Card className="card-hover-glow">
                    <CardHeader>
                      <CardTitle className="flex items-center gap-2"><Database size={16} className="text-[var(--accent)]" /> Query Dataset</CardTitle>
                    </CardHeader>
                            ...
                            <div className="bg-[var(--bg-2)] rounded-xl p-4 border border-[var(--border)]">
                              ...
                              <div className="flex flex-col gap-2 text-sm mb-4 pb-4 border-b border-[var(--border)]">
                                ...
                                <div className="flex justify-between">
                                  ...
                                  <span className="font-bold text-[var(--accent)]">${(datasetData.platform_fee / 1000000).toFixed(2)}</span>
                                </div>
                  ...
                  <Card className="card-hover-glow">
                    <CardHeader>
                      <CardTitle className="flex items-center gap-2">
                        <Globe size={18} className="text-[var(--accent)]" /> Organization Registration
                      </CardTitle>
                    </CardHeader>
                    <CardBody className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-6">
                ...
                <SpotlightCard>
                  <Card className="card-hover-glow">
                    <CardHeader>
                      <CardTitle className="flex items-center gap-2">
                        <Building size={18} className="text-[var(--accent)]" /> Verified Publisher Network
                      </CardTitle>
                    </CardHeader>
                    <CardBody className="flex flex-col gap-4">
                      {fetchingPublishers ? (
